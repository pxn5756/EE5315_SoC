...
HD_PWD='C:/Users/peter/SoC_workspace/traffic_controller/traffic_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ryg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ryg.tcl
