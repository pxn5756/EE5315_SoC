...
HD_PWD='C:/Users/peter/SoC_workspace/traffic_controller/traffic_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ryg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ryg.tcl -notrace
