...
HD_PWD='C:/Users/peter/SoC_workspace/i2c/i2c.runs/system_i2c_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_i2c_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_i2c_0_2.tcl
