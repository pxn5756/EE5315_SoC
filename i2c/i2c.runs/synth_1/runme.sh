...
HD_PWD='C:/Users/peter/SoC_workspace/i2c/i2c.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_system_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_system_top.tcl
