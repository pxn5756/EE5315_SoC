...
HD_PWD='C:/Users/peter/SoC_workspace/i2c/i2c.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_system_top.tcl -notrace
