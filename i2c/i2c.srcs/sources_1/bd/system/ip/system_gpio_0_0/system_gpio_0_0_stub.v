...
//               c:/Users/peter/SoC_workspace/gpio/gpio.gen/sources_1/bd/system/ip/system_gpio_0_0/system_gpio_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "system_gpio_0_0,gpio_v1_0,{}" *) (* CORE_GENERATION_INFO = "system_gpio_0_0,gpio_v1_0,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=gpio,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_AXI_DATA_WIDTH=32,C_AXI_ADDR_WIDTH=5}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "gpio_v1_0,Vivado 2025.1" *) 
module system_gpio_0_0(gpio_data_in, gpio_data_out, gpio_data_oe, 
...
/* synthesis syn_force_seq_prim="axi_aclk" */;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 AXI_CLK CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME AXI_CLK, ASSOCIATED_BUSIF AXI, ASSOCIATED_RESET axi_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0" *) input axi_aclk /* synthesis syn_isclock = 1 */;
