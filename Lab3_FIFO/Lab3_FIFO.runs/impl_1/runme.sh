...
HD_PWD='C:/Users/peter/SoC_workspace/Lab3_FIFO/Lab3_FIFO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_main.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_main.tcl -notrace
