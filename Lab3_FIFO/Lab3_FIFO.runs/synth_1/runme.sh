...
HD_PWD='C:/Users/peter/SoC_workspace/Lab3_FIFO/Lab3_FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_main.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_main.tcl
