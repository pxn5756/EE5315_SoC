...
HD_PWD='C:/Users/peter/SoC_workspace/gpio/gpio.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_system_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_system_top.tcl
