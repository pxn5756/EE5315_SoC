...
HD_PWD='C:/Users/peter/SoC_workspace/gpio/gpio.runs/system_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_gpio_0_0.tcl
