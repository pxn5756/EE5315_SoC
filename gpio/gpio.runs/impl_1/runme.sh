...
HD_PWD='C:/Users/peter/SoC_workspace/gpio/gpio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_system_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gpio_system_top.tcl -notrace
