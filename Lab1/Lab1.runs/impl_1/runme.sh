...
HD_PWD='C:/Users/peter/SoC_workspace/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter16Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Counter16Bit.tcl -notrace
