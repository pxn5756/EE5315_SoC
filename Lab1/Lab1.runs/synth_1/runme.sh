...
HD_PWD='C:/Users/peter/SoC_workspace/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Counter16Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Counter16Bit.tcl
