...
REM
REM Generated by Vivado on Sat Sep 06 00:22:12 -0500 2025
...
echo "xvlog --incr --relax -prj Counter16Bit_vlog.prj"
call xvlog  --incr --relax -prj Counter16Bit_vlog.prj -log xvlog.log
